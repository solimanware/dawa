...
class _DrugDetailsPageState extends State<DrugDetailsPage> {
                ...
                children: <Widget>[
                  ButtonTheme(
                    ...
                    child: RaisedButton(
                      onPressed: () {
                        _launchURL(
                            "https://www.google.com/search?tbm=isch&q=${this
                                .drug.tradename.split(" ").sublist(0, 2).join(
                                " ")} drug");
                      },
                  ...
                  ButtonTheme(
                    ...
                    child: RaisedButton(
                      onPressed: () {
                        _launchURL(
                            "https://www.google.com/search?q=${this.drug
                                .tradename.split(" ").sublist(0, 2).join(
                                " ")} drug");
                      },
  ...
  Widget SimilarDrugs() {
    return FutureBuilder<List<Drug>>(
      future: loadDrugSimilars(drug.activeingredient,drugs), // a previously-obtained Future<String> or null
          ...
          case ConnectionState.done:
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                Drug similar = snapshot.data[index];
                return similarCard(similar);
              },
            ),);
...
class DrugDetailsPage extends StatefulWidget {
  ...
  DrugDetailsPage({Key key, @required this.drug, @required this.drugs}) : super(key: key);
  @override
